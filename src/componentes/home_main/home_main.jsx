    ...
    return (
        <section className={estilo.section_cards}>
            <div className={estilo.cards_box}>
                <Image src={bannerSabores} className={estilo.box_image } alt="Varias bolas de sorvete de sabores diferêntes"></Image>
            ...
            <div className={estilo.cards_box}>
                <CardHome titulo="NOSSOS EVENTOS" alt="adicionais para por no sorvete" textoBold="Delicias com sorvete!" texto="Mais do que uma sorveteria, uma extensão da sua casa! Estamos aqui prontinhos para te atender e oferecer os melhores eventos com os melhores sorvete da sua vida! Venha nos conhecer e passar um tempo aqui com a gente."/>
                <Image className={estilo.box_image} src={bannerEvento} alt="asdasd"></Image>
            </div>
            <div className={estilo.cards_box}>
                <Image className={estilo.box_image} src={bannerSobre} alt="amigos brindando com casquinhas de sorvete"></Image>
